...
export function MobileMenu() {
  ...
  return (
    <div className="md:hidden">
      ...
      {open && (
        <>
          <div className="bg-[rgba(43,38,32,0.5)] backdrop-blur-sm fixed inset-0 z-40 md:hidden" onClick={() => setOpen(false)} />
          <div className="fixed inset-y-0 left-0 w-64 bg-[var(--bg-surface)] border-r border-[var(--border-soft)] shadow-[2px_0_12px_rgba(43,38,32,0.08)] z-50 p-4 md:hidden flex flex-col">
